...
def add_new_user():
    ...
    if find_user(user_name):
        error["text"] = "Error another USER alredy exists"
    else:
...
def delete_user():
    ...
    if commited:
        if not find_user(user_name):
            error["text"] = "User Deleted successfully"
        else:
            error["text"] = "Delete failed - Please connect Admin"
...
old_password.place(x=280,y=180,width=100,height=25)

button2 = tk.Button(text= "Show_User",command=find_my_password)
button2.place(x=150,y=220,width=105,height=35)

button3 = tk.Button(text= "Change_Pass",command=change_password)
button3.place(x=300,y=220,width=105,height=35)

button4 = tk.Button(text= "Delete",command=delete_user)
button4.place(x=450,y=220,width=105,height=35)

button5 = tk.Button(text= "Show_All",command=show_all)
button5.place(x=250,y=270,width=105,height=35)
